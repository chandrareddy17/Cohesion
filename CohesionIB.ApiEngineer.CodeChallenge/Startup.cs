...
namespace CohesionIB.ApiEngineer.CodeChallenge
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.SetupLotOInvitationCodes(Configuration.GetValue<string>("ApiKey"));
            services.AddDbContext<MyContext>(o => o.UseSqlServer(Configuration.GetConnectionString("CohesionIBDb")));
